...
async function main() {
  ...
  for (const source of sources) {
    const enabled = ["living-population", "building-register", "commercial-store", "floating-population", "rental-transaction", "estimated-sales", "road-construction", "noise-complaint", "public-program"].includes(source.code);
