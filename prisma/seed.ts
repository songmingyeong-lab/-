...
async function main() {
  ...
  for (const source of sources) {
    const enabled = ["building-register", "commercial-store", "commercial-opening-market", "commercial-rent-market", "income-consumption", "resident-population", "floating-population", "rental-transaction", "estimated-sales", "road-construction", "noise-complaint", "public-program"].includes(source.code);
