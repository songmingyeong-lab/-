...
const indicatorScoreConfigs: Omit<IndicatorScoreConfig, "scoreThresholds">[] = [
  ...
  { indicatorCode: "street_floating_population_density", category: "활력·혼잡", comparisonScope: "GURO_DONG", direction: "BALANCED", weight: 0.35, comparisonMethod: "MEAN", minimumComparisonCount: 5, normalizationMethod: "NONE", denominatorType: "NONE", enabled: true },
  { indicatorCode: "floating_population_concentration", category: "활력·혼잡", comparisonScope: "GURO_DONG", direction: "BALANCED", weight: 0.25, comparisonMethod: "MEAN", minimumComparisonCount: 5, normalizationMethod: "NONE", denominatorType: "NONE", enabled: true },
