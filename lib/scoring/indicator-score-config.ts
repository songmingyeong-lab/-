...
const indicatorScoreConfigs: Omit<IndicatorScoreConfig, "scoreThresholds">[] = [
  ...
  { indicatorCode: "vacant_house_count", category: "주거환경", comparisonScope: "GURO_DONG", direction: "LOWER_IS_BETTER", weight: 0.5, comparisonMethod: "MEAN", minimumComparisonCount: 5, normalizationMethod: "NONE", denominatorType: "NONE", enabled: true, allowRelaxedMinimum: true },
  ...
  { indicatorCode: "store_count", category: "상권 변화", comparisonScope: "GURO_DONG", direction: "PERCENTILE_REFERENCE", weight: 0.15, comparisonMethod: "MEAN", minimumComparisonCount: 5, normalizationMethod: "NONE", denominatorType: "NONE", enabled: true },
