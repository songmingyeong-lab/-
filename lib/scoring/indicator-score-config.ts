...
const indicatorScoreConfigs: Omit<IndicatorScoreConfig, "scoreThresholds">[] = [
  ...
  { indicatorCode: "vacant_house_count", category: "주거환경", comparisonScope: "INFORMATION_ONLY", direction: "INFORMATION_ONLY", weight: 0.5, comparisonMethod: "MEAN", minimumComparisonCount: 5, normalizationMethod: "NONE", denominatorType: "NONE", enabled: true, informationOnlyReason: "선택한 행정동과 비교집단에 동일하게 적용할 수 있는 공식 빈집 자료가 없습니다." },
  ...
  { indicatorCode: "store_density", category: "상권 변화", comparisonScope: "GURO_DONG", direction: "BALANCED", weight: 0.15, comparisonMethod: "MEAN", minimumComparisonCount: 5, normalizationMethod: "NONE", denominatorType: "NONE", enabled: true },
  ...
  { indicatorCode: "rental_burden", category: "상권 변화", comparisonScope: "GURO_DONG", direction: "LOWER_IS_BETTER", weight: 0.25, comparisonMethod: "MEAN", minimumComparisonCount: 5, normalizationMethod: "NONE", denominatorType: "NONE", enabled: true },
  ...
  { indicatorCode: "street_floating_population_density", category: "활력·혼잡", comparisonScope: "GURO_DONG", direction: "BALANCED", weight: 1, comparisonMethod: "MEAN", minimumComparisonCount: 5, normalizationMethod: "NONE", denominatorType: "NONE", enabled: true },
  { indicatorCode: "residential_population_density", category: "활력·혼잡", comparisonScope: "GURO_DONG", direction: "BALANCED", weight: 1, comparisonMethod: "MEAN", minimumComparisonCount: 5, normalizationMethod: "NONE", denominatorType: "NONE", enabled: true },
  { indicatorCode: "workplace_population_density", category: "활력·혼잡", comparisonScope: "GURO_DONG", direction: "BALANCED", weight: 1, comparisonMethod: "MEAN", minimumComparisonCount: 5, normalizationMethod: "NONE", denominatorType: "NONE", enabled: true },
