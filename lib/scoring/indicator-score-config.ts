...
const indicatorScoreConfigs: Omit<IndicatorScoreConfig, "scoreThresholds">[] = [
  ...
  { indicatorCode: "opening_count", category: "상권 변화", comparisonScope: "GURO_DONG", direction: "HIGHER_IS_BETTER", weight: 0, comparisonMethod: "MEAN", minimumComparisonCount: 5, normalizationMethod: "NONE", denominatorType: "NONE", enabled: true },
  ...
  { indicatorCode: "closing_count", category: "상권 변화", comparisonScope: "GURO_DONG", direction: "LOWER_IS_BETTER", weight: 0, comparisonMethod: "MEAN", minimumComparisonCount: 5, normalizationMethod: "NONE", denominatorType: "NONE", enabled: true },
  ...
  { indicatorCode: "monthly_average_income", category: "상권 변화", comparisonScope: "GURO_DONG", direction: "HIGHER_IS_BETTER", weight: 0, comparisonMethod: "MEAN", minimumComparisonCount: 5, normalizationMethod: "NONE", denominatorType: "NONE", enabled: true },
  { indicatorCode: "household_count", category: "상권 변화", comparisonScope: "GURO_DONG", direction: "BALANCED", weight: 0, comparisonMethod: "MEAN", minimumComparisonCount: 5, normalizationMethod: "NONE", denominatorType: "NONE", enabled: true },
