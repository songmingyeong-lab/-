...
const indicatorSources: Record<string, string> = {
  ...
  opening_count: "commercial-opening-market",
  opening_rate: "commercial-opening-market",
  closing_count: "commercial-opening-market",
  closing_rate: "commercial-opening-market",
  ...
  residential_population_density: "floating-population",
  workplace_population_density: "floating-population",
