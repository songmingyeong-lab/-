...
export const sourceAdapters = [livingPopulationAdapter, buildingRegisterAdapter, commercialStoreAdapter, floatingPopulationAdapter, rentalTransactionAdapter, estimatedSalesAdapter, roadExcavationAdapter, noiseComplaintAdapter, publicServiceReservationAdapter];
